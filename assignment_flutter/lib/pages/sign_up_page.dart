        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buttonItem("assets/google.svg", "Sign Up with Google", 25,
                  () async {
  ...
  Widget textItem(
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        validator: (pValue) => PwdFieldValidator.validate(pValue!),
      ),
    );
  }

  Widget colorButton() {
    pValue = _pwdController.text;
    return InkWell(
      onTap: () async {
        setState(() {
          circular = true;
